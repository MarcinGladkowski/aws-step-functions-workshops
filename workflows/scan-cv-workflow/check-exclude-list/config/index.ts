...
export interface CheckExcludeListsLambdaEnvironmentVariables {
...
const validateConfig = (config: ReturnType<typeof loadEnvs>): CheckExcludeListsLambdaEnvironmentVariables => {
